...
Bon covoiturage avec %s !""" % (
                ...
                message,
                settings.PROJECT_NAME,
                settings.DEFAULT_CLIENT_URLS['root'],
                settings.DEFAULT_CLIENT_URLS['talks']['add_message'] % (settings.DEFAULT_CLIENT_URLS['root'], talk.id),
                settings.DEFAULT_CLIENT_URLS['root'],
                settings.DEFAULT_CLIENT_URLS['talks']['list'] % (settings.DEFAULT_CLIENT_URLS['root']),
                settings.PROJECT_NAME,
            ),
            settings.FROM_EMAIL, [to_user.email]
        )
